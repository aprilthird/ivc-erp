...
namespace IVC.PE.DATA.Migrations
{
    ...
    [Migration("20201022225335_UpdateRdpItemModule3")]
    partial class UpdateRdpItemModule3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IVC.PE.ENTITIES.Models.Production.RdpItemFootage", b =>
                {
                    ...
                    b.Property<decimal?>("Contractual")
                        .HasColumnType("decimal(18,2)");

                    b.Property<Guid>("ProjectId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime>("RdpDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("IVC.PE.ENTITIES.Models.Production.RdpItemTotal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IVC.PE.ENTITIES.Models.Quality.EquipmentCertificate", b =>
                {
                    ...
                    b.Property<int>("CalibrationVerificationFrecuency")
                        .HasColumnType("int");

                    b.Property<int>("CalibrationVerificationMethod")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IVC.PE.ENTITIES.Models.Quality.EquipmentCertificateRenewal", b =>
                {
                    ...
                    b.Property<string>("CertifyingEntity")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("IVC.PE.ENTITIES.Models.Security.RdpReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<float>("InstalledPipe")
                        .HasColumnType("real");

                    b.Property<int>("NumberOfOfficials")
                        .HasColumnType("int");

                    b.Property<int>("NumberOfOperators")
                        .HasColumnType("int");

                    b.Property<int>("NumberOfPawns")
                        .HasColumnType("int");

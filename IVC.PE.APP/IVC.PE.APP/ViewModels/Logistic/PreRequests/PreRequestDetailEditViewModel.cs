...
{
    public class PreRequestDetailEditViewModel : BaseViewModel
    {//--------
        #region Front
        ...
        #endregion
        //--------------
        public PreRequestDetailEditViewModel(Guid id,Guid projectFormulaId, Guid supplyFamilyId, Guid preRequestId, Guid projectId)
        {
            this.DetailId = id;
            this.apiService = new ApiService();
            this.SelectedProjectFormulaId = projectFormulaId;
            this.SelectedFamilyId = supplyFamilyId;

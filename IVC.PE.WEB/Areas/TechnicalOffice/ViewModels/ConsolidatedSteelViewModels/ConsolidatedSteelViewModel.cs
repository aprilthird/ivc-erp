...
namespace IVC.PE.WEB.Areas.TechnicalOffice.ViewModels.ConsolidatedSteelViewModels
{
    public class ConsolidatedSteelViewModel
    {
        ...
        [Display(Name = "Metrado Contractual (Kg)", Prompt = "Metrado Contractual")]
        ...
        [Display(Name = "Metrado Replanteo (Kg)", Prompt = "Metrado Replanteo")]

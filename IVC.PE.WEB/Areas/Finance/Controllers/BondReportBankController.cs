...
using IVC.PE.WEB.Areas.Finance.ViewModels.BondReportViewModel;
...
namespace IVC.PE.WEB.Areas.Finance.Controllers
{
    ...
    [Route("finanzas/reportebancofianza")]
    public class BondReportBankController : BaseController
    {
        private readonly IOptions<CloudStorageCredentials> _storageCredentials;

        public BondReportBankController(IvcDbContext context,
             IOptions<CloudStorageCredentials> storageCredentials,
           ILogger<BondReportBankController> logger) : base(context, logger)
        {

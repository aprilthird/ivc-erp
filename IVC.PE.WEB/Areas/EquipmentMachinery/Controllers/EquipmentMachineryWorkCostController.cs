...
namespace IVC.PE.WEB.Areas.EquipmentMachinery.Controllers
{
    ...
    [Route("equipos/costo-transporte")]
    public class EquipmentMachineryWorkCostController : BaseController
    {

        public EquipmentMachineryWorkCostController(IvcDbContext context,
ILogger<EquipmentMachineryWorkCostController> logger) : base(context, logger)
        {

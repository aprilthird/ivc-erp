var LettersReceived = function () {

    var lettersReceivedDatatable = null;
    ...
    var options = {
        ...
        //processing: true,
        ajax: {
            url: _app.parseUrl("/control-documentario/cartas-recibidas/listar"),
            data: function (d) {
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data) {
                    ...
                    if (data > 0) {
                        ...
                        tmp += `<span class="kt-switch kt-switch--icon"><label><span class="kt-badge kt-badge--inline kt-badge--pill kt-badge--info">Recibida</span></label></span>`;
                    }
                    return tmp;
                }
            },
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    tmp += `<button data-id="${row.letterId}" class="btn btn-info btn-sm btn-icon btn-send">`;
    ...
    var refOpt = {
        responsive: true,
        ajax: {
            url: _app.parseUrl(`/control-documentario/cartas-recibidas/listar-referencias`),
            data: function (d) {
                d.letterId = letterId;
                delete d.columns;
            },
    ...
    var datatable = {
        init: function () {
            lettersReceivedDatatable = $("#letter_datatable").DataTable(options);
            this.initEvents();
            this.filesDt.init();
        },
        reload: function () {
            lettersReceivedDatatable.ajax.reload();
        },
        initEvents: function () {
            lettersReceivedDatatable.on("click",
                ".btn-edit",
                function () {
                    let $btn = $(this);
                    let id = $btn.data("id");
            ...
            lettersReceivedDatatable.on("click", ".btn-view", function () {
                let $btn = $(this);
                let id = $btn.data("id");
            ...
            lettersReceivedDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "La carta recibida será eliminada permanentemente",
                        type: "warning",
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/control-documentario/cartas-recibidas/eliminar/${id}`),
                                    type: "delete",
                                    success: function (result) {
                                        ...
                                        swal.fire({
                                            type: "success",
                                            title: "Completado",
                                            text: "La carta recibida ha sido eliminada con éxito",
            ...
            lettersReceivedDatatable.on("click",
                ...
                function () {
                    ...
                    let id = $btn.data("id");
                    $.ajax({
                        url: _app.parseUrl(`/control-documentario/cartas-recibidas/enviar-correo/${id}`),
                        success: function (result) {
                            datatable.reload();
                            swal.fire({
                                type: "success",
                                title: "Completado",
                                text: "Carta enviada con éxito",
                                confirmButtonText: "Excelente"
                            });
                        },
                        error: function (errormessage) {
            ...
            lettersReceivedDatatable.on("click", ".btn-details", function () {
                let $btn = $(this);
                let id = $btn.data("id");
            ...
            lettersReceivedDatatable.on("click", ".btn-answers", function () {
                let $btn = $(this);
                let id = $btn.data("id");
                isFromReference = false;
    ...
    var form = {
            ...
            edit: function (id) {
                ...
                $.ajax({
                    ...
                    .done(function (result) {
                        ...
                        formElements.find("[name='IssuerId']").val(result.issuerId).trigger("change");
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/control-documentario/cartas-recibidas/crear"),
                    method: "post",
                    contentType: false,
                    processData: false,
                    data: data,
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/control-documentario/cartas-recibidas/editar/${id}`),
                    method: "put",
                    data: data,
                    contentType: false,
                    processData: false,
            ...
            import: {
                data: function (formElement) {
                    ...
                    $.ajax({
                        url: "/control-documentario/cartas-recibidas/importar-datos",
                        type: "POST",
                        contentType: false,
                        processData: false,
                        data: data,
        ...
        reset: {
            add: function () {
                ...
                $("#Add_EmployeeId").val(null).trigger("change");
                $("#Add_IssuerId").val(null).trigger("change");
            ...
            edit: function () {
                ...
                $("#Edit_EmployeeId").val(null).trigger("change");
                $("#Edit_IssuerId").val(null).trigger("change");
                $(".fileinput").fileinput("clear");
            },
            import: {
                data: function () {
    ...
    var events = {
        init: function () {
            ...
            $("#add_form [name='IssuerId']").attr("id", "Add_IssuerId");
            $("#edit_form [name='IssuerId']").attr("id", "Edit_IssuerId");
            $("#add_form [name='File']").attr("id", "Add_File");

            $("#status_filter, #interest_group_filter, #has_answer").on("change", function () {
                datatable.reload();
            });
            /* has_file
            ...
            */
            ...
            $.ajax({
                url: _app.parseUrl("/control-documentario/cartas-recibidas/emisores")
            }).done(function (result) {
            ...
            $("#btn_LoadAnsPdf").on("click", function () {
                ...
                $.ajax({
                    ...
                    console.log(result);
                    loadPdf(result.name, result.fileUrl, "anwers_pdf_views");
                    //$("#ans_frame").prop("src", "https://docs.google.com/gview?url=" + result.fileUrl + "&embedded=true");
                })
            });

            $(".btn-exportar").on("click", function () {
                window.location = _app.parseUrl(`/control-documentario/cartas-recibidas/exportar`);
            });
        }
    };

var Formula = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/control-documentario/responsables/listar"),
            dataSrc: ""
        },
        columns: [
            {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/control-documentario/responsables/eliminar/${id}`),
                                    type: "delete",
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/control-documentario/responsables/${id}`)
        ...
        submit: {
            add: function (formElement) {
                ...
                $btn.addLoader();
                $.ajax({
                    url: _app.parseUrl("/control-documentario/responsables/crear"),
                    type: "post",
                    data: data
                }).always(function () {
            ...
            edit: function (formElement) {
                ...
                $btn.addLoader();
                $.ajax({
                    url: _app.parseUrl(`/control-documentario/responsables/editar`),
                    type: "put",
                    data: data
                }).always(function () {
                    $(formElement).find("input").prop("disabled", false);

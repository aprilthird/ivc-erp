var CertificateTypé = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/control-documentario/tipo-libros-de-obra/listar"),
            dataSrc: ""
        },
        columns: [
            {
            ...
            ,
            {
                title: "Tipo de Cuaderno de obra",
                data: "description"
            },
            {
                title: "Proyecto",
        ...
        initEvents: function () {
            ...
            mainDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "el tipo de libro será eliminada permanentemente",
                        type: "warning",
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/control-documentario/tipo-libros-de-obra/eliminar/${id}`),
                                    type: "delete",
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/control-documentario/tipo-libros-de-obra/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/control-documentario/tipo-libros-de-obra/crear"),
                    method: "post",
                    data: data
                })
                    .always(function () {
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/control-documentario/tipo-libros-de-obra/editar/${id}`),
                    method: "put",
                    data: data
                })
                    .always(function () {

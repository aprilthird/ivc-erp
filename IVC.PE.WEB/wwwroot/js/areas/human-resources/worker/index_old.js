            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    if (row.isActive == true) {
                        tmp += `<button data-id="${row.id}" class="btn btn-warning btn-sm btn-icon btn-cease">`;
                        tmp += `<i class="fa fa-calendar-times"></i></button>`;
                    } else {
                        tmp += `<button data-id="${row.id}" class="btn btn-success btn-sm btn-icon btn-new-entry">`;

var MachineryType = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/oficina-tecnica/modulo/listar"),
            dataSrc: ""
        },
        columns: [
        ...
        initEvents: function () {
            ...
            mainDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "El modulo será eliminado permanentemente",
                        type: "warning",
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/oficina-tecnica/modulo/eliminar/${id}`),
                                    type: "delete",
                                    success: function (result) {
                                        ...
                                        swal.fire({
                                            type: "success",
                                            title: "Completado",
                                            text: "El modulo ha sido eliminado con éxito",
                                    ...
                                    error: function (errormessage) {
                                        swal.fire({
                                            ...
                                            text: "Ocurrió un error al intentar eliminar el modulo"
                                        });
                                    }
                                });
                            });
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/modulo/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/oficina-tecnica/modulo/crear"),
                    method: "post",
                    data: data
                })
                    .always(function () {
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/modulo/editar/${id}`),
                    method: "put",
                    data: data
                })
                    .always(function () {

var IsoStandard = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/oficina-tecnica/especificaciones-tecnicas/listar"),
            data: function (d) {
        ...
        columns: [
            {
                title: "Familia",
                data: "supplyFamilyCode",
                render: function (data, type, row) {
                    var tmp = data + "-" + row.supplyFamilyName;
            ...
            {
                title: "Grupo",
                data: "supplyGroupCode",
                render: function (data, type, row) {
                    var tmp = data + "-" + row.supplyGroupName;
        ...
        initEvents: function () {
            ...
            isoStandardDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "la especificación será eliminado permanentemente",
                        type: "warning",
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/oficina-tecnica/especificaciones-tecnicas/eliminar/${id}`),
                                    type: "delete",
                                    success: function (result) {
                                        ...
                                        swal.fire({
                                            type: "success",
                                            title: "Completado",
                                            text: "la especificación sido eliminada con éxito",
                                    ...
                                    error: function (errormessage) {
                                        swal.fire({
                                            ...
                                            text: "Ocurrió un error al intentar eliminar la especificación"
                                        });
                                    }
                                });
                            });
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/especificaciones-tecnicas/${id}`)
                })
                    .done(function (result) {
                        ...
                        formElements.find("[name='Specialities']").val(result.specialities);
                        formElements.find("[name='select_specialities']").val(result.specialities);
                        $(".select2-specs").trigger('change');
        ...
        submit: {
            add: function (formElement) {
                ...
                $(formElement).find("[name='Specialities']").append($(formElement).find("[name='select_specialities']").val());
                ...
                $.ajax({
                    url: _app.parseUrl("/oficina-tecnica/especificaciones-tecnicas/crear"),
                    method: "post",
                    contentType: false,
                    processData: false,
                    data: data,
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/especificaciones-tecnicas/editar/${id}`),
                    method: "put",
                    contentType: false,
                    processData: false,
                    data: data,
        ...
        reset: {
            add: function () {
                ...
                $("#Add_Specialities").prop("selectedIndex", 0).trigger("change");
            },
            edit: function () {
                editForm.resetForm();
                $("#edit_form").trigger("reset");
                $("#edit_alert").removeClass("show").addClass("d-none");
                $("#Edit_Specialities").prop("selectedIndex", 0).trigger("change");
            }
        }
    };
    ...
    var events = {
        init: function () {
            ...
            $("#add_form [name='Specialities']").attr("id", "Add_Specialities");
            $("#edit_form [name='Specialities']").attr("id", "Edit_Specialities");

var CementType = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/oficina-tecnica/tipo-de-documento/listar"),
            dataSrc: ""
        },
        columns: [
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/oficina-tecnica/tipo-de-documento/eliminar/${id}`),
                                    type: "delete",
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/tipo-de-documento/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/oficina-tecnica/tipo-de-documento/crear"),
                    method: "post",
                    data: data
                })
                    .always(function () {
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/tipo-de-documento/editar/${id}`),
                    method: "put",
                    data: data
                })
                    .always(function () {

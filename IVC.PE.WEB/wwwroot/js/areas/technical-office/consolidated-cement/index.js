var Cement = function () {
    ...
    var cementDtOpt = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/oficina-tecnica/consolidado-cementos/listar"),
            data: function (d) {
                        ...
                        Swal.fire({
                            ...
                            preConfirm: () => {
                                return new Promise((resolve) => {
                                    $.ajax({
                                        url: _app.parseUrl(`/oficina-tecnica/consolidado-cementos/eliminar/${id}`),
                                        type: "delete",
    ...
    var forms = {
        load: {
            affectation: function () {
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/consolidado-cementos/f1`)
                })
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/consolidado-cementos/f2`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/consolidado-cementos/f3`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/consolidado-cementos/f4`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/consolidado-cementos/f5`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/consolidado-cementos/f6`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/consolidado-cementos/f7`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
            ...
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/consolidado-cementos/${id}`)
                })
                    .done(function (result) {
                        console.log(result);
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/oficina-tecnica/consolidado-cementos/crear"),
                    method: "post",
                    data: data,
                    contentType: false,
                    processData: false
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/consolidado-cementos/editar/${id}`),
                    method: "put",
                    contentType: false,
                    processData: false,
                    data: data
            ...
            load: {
                data: function (formElement) {
                    ...
                    $btn.addLoader();
                    $.ajax({
                        url: "/oficina-tecnica/consolidado-cementos/afectacion",
                        type: "POST",
                        contentType: false,
                        processData: false,
                        data: data
    ...
    var select2 = {
        ...
        totals: function () {
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/consolidado-cementos/metrado-contractual-tipo-uno"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
            ...
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/consolidado-cementos/metrado-contractual-tipo-cinco"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
            ...
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/consolidado-cementos/metrado-replanteado-tipo-uno"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
            ...
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/consolidado-cementos/metrado-replanteado-tipo-cinco"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
    ...
    var events = {
        excel: function () {
            $("#btn-massive-load").on("click", function () {
                window.location = `/oficina-tecnica/consolidado-cementos/excel-carga-masiva`;
            });
        },
        deleteByFilters: function () {
            $("#btn-delete-by-filters").on("click", function () {
                Swal.fire({
                    title: "¿Está seguro?",
                    text: "Los consolidado-cementos filtrados serán eliminados permanentemente",
                    type: "warning",
                    showCancelButton: true,
                    confirmButtonText: "Sí, eliminarla",
                    confirmButtonClass: "btn-danger",
                    ...
                    preConfirm: () => {
                        return new Promise((resolve) => {
                            $.ajax({
                                url: _app.parseUrl(`/oficina-tecnica/consolidado-cementos/eliminar-filtro`),
                                data: {
                                    projectFormulaId: $("#project_formula_filter").val(),
                                    budgetTitleId: $("#budget_title_filter").val()
                                },
                                ...
                                success: function (result) {
                                    ...
                                    swal.fire({
                                        type: "success",
                                        title: "Completado",
                                        text: "Los consolidado-cementos han sido eliminados con éxito",
                                        confirmButtonText: "Excelente"
                                    });
                                },

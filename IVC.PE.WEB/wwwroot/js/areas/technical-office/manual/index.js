var IsoStandard = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/oficina-tecnica/manuales/listar"),
            data: function (d) {

                d.moduleId = $("#spec_filter").val();
        ...
        initEvents: function () {
            ...
            isoStandardDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "el manual será eliminado permanentemente",
                        type: "warning",
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/oficina-tecnica/manuales/eliminar/${id}`),
                                    type: "delete",
                                    success: function (result) {
                                        ...
                                        swal.fire({
                                            type: "success",
                                            title: "Completado",
                                            text: "el manual sido eliminada con éxito",
                                    ...
                                    error: function (errormessage) {
                                        swal.fire({
                                            ...
                                            text: "Ocurrió un error al intentar eliminar el manual"
                                        });
                                    }
                                });
                            });
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/manuales/${id}`)
                })
                    .done(function (result) {
                        ...
                        formElements.find("[name='AreaModuleId']").val(result.areaModuleId);
                        formElements.find("[name='select_module']").val(result.areaModuleId).trigger("change");
        ...
        submit: {
            add: function (formElement) {
                ...
                $(formElement).find("[name='AreaModuleId']").val($(formElement).find("[name='select_module']").val());
                ...
                $.ajax({
                    url: _app.parseUrl("/oficina-tecnica/manuales/crear"),
                    method: "post",
                    contentType: false,
                    processData: false,
                    data: data,
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/manuales/editar/${id}`),
                    method: "put",
                    contentType: false,
                    processData: false,
                    data: data,
    ...
    var select2 = {
        ...
        modules: {
            init: function () {
                ...
                $.ajax({
                    url: _app.parseUrl(`/select/modulos`)
                }).done(function (result) {

var ConsolidatedAmountSteel = function () {
    ...
    var steelDtOpt = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/oficina-tecnica/monto-consolidado-aceros/listar"),
            data: function (d) {
    ...
    var datatables = {
        ...
        steelDt: {
            init: function () {
                steelDatatable = $("#consolidatedAmountSteels_datatable").DataTable(steelDtOpt);
                this.initEvents();
            },
            reload: function () {
                        ...
                        Swal.fire({
                            ...
                            preConfirm: () => {
                                return new Promise((resolve) => {
                                    $.ajax({
                                        url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-aceros/eliminar/${id}`),
                                        type: "delete",
    ...
    var forms = {
        load: {
            affectation: function () {
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-aceros/f1`)
                })
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-aceros/f2`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-aceros/f3`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-aceros/f4`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-aceros/f5`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-aceros/f6`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-aceros/f7`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
            ...
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-aceros/${id}`)
                })
                    .done(function (result) {
                        console.log(result);
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/oficina-tecnica/monto-consolidado-aceros/crear"),
                    method: "post",
                    data: data,
                    contentType: false,
                    processData: false
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-aceros/editar/${id}`),
                    method: "put",
                    contentType: false,
                    processData: false,
                    data: data
            ...
            load: {
                data: function (formElement) {
                    ...
                    $btn.addLoader();
                    $.ajax({
                        url: "/oficina-tecnica/monto-consolidado-aceros/afectacion",
                        type: "POST",
                        contentType: false,
                        processData: false,
                        data: data
    ...
    var select2 = {
        ...
        Totals: function () {
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/monto-consolidado-aceros/metrado-contractual"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
            ...
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/monto-consolidado-aceros/rod6mm"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
            ...
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/monto-consolidado-aceros/rod8mm"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
            ...
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/monto-consolidado-aceros/rod3x8"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
            ...
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/monto-consolidado-aceros/rod1x2"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
            ...
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/monto-consolidado-aceros/rod5x8"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
            ...
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/monto-consolidado-aceros/rod3x4"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
            ...
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/monto-consolidado-aceros/rod1"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
            ...
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/monto-consolidado-aceros/metrado-replanteado"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
    ...
    var events = {
        excel: function () {
            $("#btn-massive-load").on("click", function () {
                window.location = `/oficina-tecnica/monto-consolidado-aceros/excel-carga-masiva`;
            });
        },
        deleteByFilters: function () {
            $("#btn-delete-by-filters").on("click", function () {
                Swal.fire({
                    title: "¿Está seguro?",
                    text: "Los monto-consolidado-aceros filtrados serán eliminados permanentemente",
                    type: "warning",
                    showCancelButton: true,
                    confirmButtonText: "Sí, eliminarla",
                    confirmButtonClass: "btn-danger",
                    ...
                    preConfirm: () => {
                        return new Promise((resolve) => {
                            $.ajax({
                                url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-aceros/eliminar-filtro`),
                                data: {
                                    projectFormulaId: $("#project_formula_filter").val(),
                                    budgetTitleId: $("#budget_title_filter").val()
                                },
                                ...
                                success: function (result) {
                                    ...
                                    swal.fire({
                                        type: "success",
                                        title: "Completado",
                                        text: "Los monto-consolidado-aceros han sido eliminados con éxito",
                                        confirmButtonText: "Excelente"
                                    });
                                },
        ...
        affectation: function () {
            $("#btn-update").on("click", function () {
                _app.loader.show();
                $.ajax({
                    url: "/oficina-tecnica/monto-consolidado-aceros/cargar",
                    type: "POST",
                    contentType: false,
                    processData: false
                }).always(function () {

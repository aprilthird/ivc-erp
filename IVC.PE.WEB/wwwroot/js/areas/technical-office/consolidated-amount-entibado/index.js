var Entibado = function () {
    ...
    var entibadoDtOpt = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/oficina-tecnica/monto-consolidado-entibados/listar"),
            data: function (d) {
                        ...
                        Swal.fire({
                            ...
                            preConfirm: () => {
                                return new Promise((resolve) => {
                                    $.ajax({
                                        url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-entibados/eliminar/${id}`),
                                        type: "delete",
    ...
    var forms = {
        load: {
            affectation: function () {
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-entibados/f1`)
                })
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-entibados/f2`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-entibados/f3`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-entibados/f4`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-entibados/f5`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-entibados/f6`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-entibados/f7`)
                })
                    .done(function (result) {
                        let formElements = $("#load_data_form");
            ...
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-entibados/${id}`)
                })
                    .done(function (result) {
                        console.log(result);
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/oficina-tecnica/monto-consolidado-entibados/crear"),
                    method: "post",
                    data: data,
                    contentType: false,
                    processData: false
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-entibados/editar/${id}`),
                    method: "put",
                    contentType: false,
                    processData: false,
                    data: data
            ...
            load: {
                data: function (formElement) {
                    ...
                    $btn.addLoader();
                    $.ajax({
                        url: "/oficina-tecnica/monto-consolidado-entibados/afectacion",
                        type: "POST",
                        contentType: false,
                        processData: false,
                        data: data
    ...
    var select2 = {
        ...
        totals: function () {
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/monto-consolidado-entibados/metrado-ks60"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                ...
                .done(function (result) {
                    $("#total_ks60").val(result[0]);
                    $("#total_ks60_consolidated").val(result[1]);
                });
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/monto-consolidado-entibados/metrado-ks100"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
                ...
                .done(function (result) {
                    $("#total_ks100").val(result[0]);
                    $("#total_ks100_consolidated").val(result[1]);
                });
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/monto-consolidado-entibados/metrado-realza-extension"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
                ...
                .done(function (result) {
                    $("#total_realza_extension").val(result[0]);
                    $("#total_realza_extension_consolidated").val(result[1]);
                });
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/monto-consolidado-entibados/metrado-corredera"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
                ...
                .done(function (result) {
                    $("#total_corredera").val(result[0]);
                    $("#total_corredera_consolidated").val(result[1]);
                });
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/monto-consolidado-entibados/metrado-paralelo"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
                ...
                .done(function (result) {
                    $("#total_paralelo").val(result[0]);
                    $("#total_paralelo_consolidated").val(result[1]);
                });
            //---------------------------
            $.ajax({
                url: _app.parseUrl("/oficina-tecnica/monto-consolidado-entibados/total"),
                data: {
                    projectFormulaId: $("#project_formula_filter").val(),
                    budgetTitleId: $("#budget_title_filter").val(),
                    workFrontId: $("#work_front_filter").val(),
                ...
                .done(function (result) {
                    $("#total_suma").val(result[0]);
                    $("#total_suma_consolidated").val(result[1]);
                });
        }
    };
    ...
    var events = {
        excel: function () {
            $("#btn-massive-load").on("click", function () {
                window.location = `/oficina-tecnica/monto-consolidado-entibados/excel-carga-masiva`;
            });
        },
        deleteByFilters: function () {
            $("#btn-delete-by-filters").on("click", function () {
                Swal.fire({
                    title: "¿Está seguro?",
                    text: "Los monto-consolidado-entibados filtrados serán eliminados permanentemente",
                    type: "warning",
                    showCancelButton: true,
                    confirmButtonText: "Sí, eliminarla",
                    confirmButtonClass: "btn-danger",
                    ...
                    preConfirm: () => {
                        return new Promise((resolve) => {
                            $.ajax({
                                url: _app.parseUrl(`/oficina-tecnica/monto-consolidado-entibados/eliminar-filtro`),
                                data: {
                                    projectFormulaId: $("#project_formula_filter").val(),
                                    budgetTitleId: $("#budget_title_filter").val()
                                },
                                ...
                                success: function (result) {
                                    ...
                                    swal.fire({
                                        type: "success",
                                        title: "Completado",
                                        text: "Los monto-consolidado-entibados han sido eliminados con éxito",
                                        confirmButtonText: "Excelente"
                                    });
                                },
        ...
        affectation: function () {
            $("#btn-update").on("click", function () {
                _app.loader.show();
                $.ajax({
                    url: "/oficina-tecnica/monto-consolidado-entibados/cargar",
                    type: "POST",
                    contentType: false,
                    processData: false
                }).always(function () {

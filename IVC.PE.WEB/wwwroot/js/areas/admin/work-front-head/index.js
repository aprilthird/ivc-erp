var WorkFrontHead = function () {

    var workFrontHeadDatatable = null;
    var addForm = null;
    var editForm = null;
    var importForm = null;
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/admin/jefes-de-frente/listar"),
            dataSrc: "",
            data: function (d) {
                delete d.columns;
            } 
    ...
    var datatable = {
        init: function () {
            workFrontHeadDatatable = $("#work_front_head_datatable").DataTable(options);
            this.initEvents();
        },
        reload: function () {
            workFrontHeadDatatable.ajax.reload();
        },
        initEvents: function () {
            workFrontHeadDatatable.on("click",
                ".btn-edit",
                function () {
                    let $btn = $(this);
                    let id = $btn.data("id");
            ...
            workFrontHeadDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "El jefe de frente será eliminado permanentemente",
                        type: "warning",
                                ...
                                $.ajax({
                                    ...
                                    success: function (result) {
                                        ...
                                        swal.fire({
                                            type: "success",
                                            title: "Completado",
                                            text: "El jefe de frente ha sido eliminado con éxito",
                                    ...
                                    error: function (errormessage) {
                                        swal.fire({
                                            ...
                                            text: "Ocurrió un error al intentar eliminar el jefe de frente"
                                        });
                                    }
                                });
                            });
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/admin/jefes-de-frente/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/admin/jefes-de-frente/crear"),
                    method: "post",
                    data: data
                })
                    .always(function () {
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/admin/jefes-de-frente/editar/${id}`),
                    method: "put",
                    data: data
                })
                    .always(function () {
            ...
            import: function (formElement) {
                ...
                $.ajax({
                    url: "/admin/jefes-de-frente/importar",
                    type: "POST",
                    contentType: false,
                    processData: false,
                    data: data,
        ...
        reset: {
            add: function () {
                ...
                $("#add_form [name='UserId']").val(null).trigger("change");
            ...
            edit: function () {
                ...
                $("#edit_form [name='UserId']").val(null).trigger("change");
                $("#add_form [name='ProjectId']").val(null).trigger("change");
            },
            import: function () {

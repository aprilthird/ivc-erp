var Main = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/calidad/procedimientos-instructivos/listar"),
            dataSrc: ""
        },
        columns: [
            {
            ...
            {
                title: "Procedimiento Instructivo",
                data: "title"
            },
            {
        ...
        initEvents: function () {
            ...
            mainDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "El Procedimiento Instructivo será eliminado permanentemente",
                        type: "warning",
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/calidad/procedimientos-instructivos/eliminar/${id}`),
                                    type: "delete",
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/calidad/procedimientos-instructivos/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/calidad/procedimientos-instructivos/crear"),
                    method: "post",
                    contentType: false,
                    processData: false,
                    data: data,
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/calidad/procedimientos-instructivos/editar/${id}`),
                    method: "put",
                    contentType: false,
                    processData: false,
                    data: data,

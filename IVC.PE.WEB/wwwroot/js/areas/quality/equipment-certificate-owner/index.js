var Owner = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/calidad/propietario/listar"),
            dataSrc: ""
        },
        columns: [
            {
        ...
        initEvents: function () {
            ...
            mainDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "El Propietario será eliminada permanentemente",
                        type: "warning",
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/calidad/propietario/eliminar/${id}`),
                                    type: "delete",
                                    ...
                                    error: function (errormessage) {
                                        swal.fire({
                                            ...
                                            text: "Ocurrió un error al intentar eliminar al propietario"
                                        });
                                    }
                                });
                            });
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/calidad/propietario/${id}`)
                })
                    .done(function (result) {
                        console.log(result);
                        let formElements = $("#edit_form");
                        formElements.find("[name='Id']").val(result.id);
                        formElements.find("[name='OwnerName']").val(result.ownerName);
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/calidad/propietario/crear"),
                    method: "post",
                    data: data
                })
                    .always(function () {
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/calidad/propietario/editar/${id}`),
                    method: "put",
                    data: data
                })
                    .always(function () {

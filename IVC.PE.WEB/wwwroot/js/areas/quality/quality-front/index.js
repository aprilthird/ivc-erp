var QualityFront = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/calidad/frentes/listar"),
            dataSrc: ""
        },
        columns: [
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/calidad/frentes/eliminar/${id}`),
                                    type: "delete",
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/calidad/frentes/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/calidad/frentes/crear"),
                    method: "post",
                    data: data
                })
                    .always(function () {
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/calidad/frentes/editar/${id}`),
                    method: "put",
                    data: data
                })
                    .always(function () {

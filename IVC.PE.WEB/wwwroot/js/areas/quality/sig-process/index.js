var Main = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/calidad/procesos-sig/listar"),
            dataSrc: ""
        },
        columns: [
            {
        ...
        initEvents: function () {
            ...
            mainDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "El Proceso SIG Instructivo será eliminado permanentemente",
                        type: "warning",
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/calidad/procesos-sig/eliminar/${id}`),
                                    type: "delete",
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/calidad/procesos-sig/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/calidad/procesos-sig/crear"),
                    method: "post",
                    contentType: false,
                    processData: false,
                    data: data,
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/calidad/procesos-sig/editar/${id}`),
                    method: "put",
                    contentType: false,
                    processData: false,
                    data: data,

var Provider = function () {
    ...
    var options = {
        ...
        responsive: true,
        ajax: {
            url: _app.parseUrl("/finanzas/reportefianza/listar"),
            dataSrc: "",


            data: function (d) {
                d.projectId = $("#supply_family_filter").val();
        ...
        columns: [
            ...
            
            {
                ...
                "createdCell": function (td, row, data, start, end, display) {
                    ...
                    //$(api.column(11).footer()).html(friTotal);
    ...
    var genOptionsDetails = function (id) {
        var result = {
            responsive: true,
            ajax: {
                url: _app.parseUrl(`/finanzas/reportefianza/${id}/archivos/listar`),
                dataSrc: ""
            },
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/finanzas/reportefianza/eliminar/${id}`),
                                    type: "delete",
                ...
                table.on("click", ".btn-file-delete", function () {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/finanzas/reportefianza/${providerId}/archivos/eliminar/${id}`),
                                    type: "delete",
                                    success: function (result) {
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/finanzas/reportefianza/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/finanzas/reportefianza/crear"),
                    method: "post",
                    data: data
                })
                    .always(function () {
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/finanzas/reportefianza/editar/${id}`),
                    method: "put",
                    data: data
                })
                    .always(function () {
            ...
            import: function (formElement) {
                ...
                $.ajax({
                    url: "/finanzas/reportefianza/importar",
                    type: "POST",
                    contentType: false,
                    processData: false,
                    data: data,
            ...
            file: {
                add: function (formElement) {
                    ...
                    $.ajax({
                        url: _app.parseUrl(`/finanzas/reportefianza/${providerId}/archivos/crear`),
                        method: "post",
                        contentType: false,
                        processData: false,
                        data: data,
    ...
    var select2 = {
        ...
        projects: {
            init: function () {
                $.ajax({
                    url: _app.parseUrl("/select/proyectos?existRegister=true")
                }).done(function (result) {

var GeneralConstructionProcedure = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/libreria-tecnica/procedimientos-constructivos-generales/listar"),
            dataSrc: ""
        },
        columns: [
            {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/libreria-tecnica/procedimientos-constructivos-generales/eliminar/${id}`),
                                    type: "delete",
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/libreria-tecnica/procedimientos-constructivos-generales/${id}`)
                })
                    .done(function (result) {
                        ...
                        formElements.find("[name='EffectiveDate']").datepicker("setDate", result.effectiveDate);
                        if (result.fileUrl) {
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/libreria-tecnica/procedimientos-constructivos-generales/crear"),
                    method: "post",
                    contentType: false,
                    processData: false,
                    data: data,
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/libreria-tecnica/procedimientos-constructivos-generales/editar/${id}`),
                    method: "put",
                    contentType: false,
                    processData: false,
                    data: data,
...
$(function () {
    GeneralConstructionProcedure.init();
});
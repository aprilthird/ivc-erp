var GeneralPolicy = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/biblioteca-tecnica/politicas-generales/listar"),
            dataSrc: ""
        },
        columns: [
            {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/biblioteca-tecnica/politicas-generales/eliminar/${id}`),
                                    type: "delete",
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/biblioteca-tecnica/politicas-generales/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/biblioteca-tecnica/politicas-generales/crear"),
                    method: "post",
                    contentType: false,
                    processData: false,
                    data: data,
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/biblioteca-tecnica/politicas-generales/editar/${id}`),
                    method: "put",
                    contentType: false,
                    processData: false,
                    data: data,

                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/libreria-tecnica/catalogo-proveedores/catalogo-eliminar/${id}`),
                                    type: "delete",
    ...
    var form = {
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/libreria-tecnica/catalogo-proveedores/crear-catalogo`),
                    method: "post",
                    contentType: false,
                    processData: false,
                    data: data,
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/libreria-tecnica/catalogo-proveedores/catalogo-editar/${id}`),
                    method: "put",
                    contentType: false,
                    processData: false,
                    data: data,

var IsoStandard = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/biblioteca-tecnica/normas-iso/listar"),
            dataSrc: ""
        },
        columns: [
            {
        ...
        initEvents: function () {
            ...
            isoStandardDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "La Norma ISO será eliminado permanentemente",
                        type: "warning",
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/biblioteca-tecnica/normas-iso/eliminar/${id}`),
                                    type: "delete",
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/biblioteca-tecnica/normas-iso/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/biblioteca-tecnica/normas-iso/crear"),
                    method: "post",
                    contentType: false,
                    processData: false,
                    data: data,
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/biblioteca-tecnica/normas-iso/editar/${id}`),
                    method: "put",
                    contentType: false,
                    processData: false,
                    data: data,

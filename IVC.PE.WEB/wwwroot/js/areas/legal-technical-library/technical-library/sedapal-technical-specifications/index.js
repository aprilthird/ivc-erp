var SedapalTechnicalSpecification = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/libreria-tecnica/especificaciones-tecnicas-sedapal/listar"),
            dataSrc: ""
        },
        columns: [
            {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/libreria-tecnica/especificaciones-tecnicas-sedapal/eliminar/${id}`),
                                    type: "delete",
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/libreria-tecnica/especificaciones-tecnicas-sedapal/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/libreria-tecnica/especificaciones-tecnicas-sedapal/crear"),
                    method: "post",
                    contentType: false,
                    processData: false,
                    data: data,
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/libreria-tecnica/especificaciones-tecnicas-sedapal/editar/${id}`),
                    method: "put",
                    contentType: false,
                    processData: false,
                    data: data,
...
$(function () {
    SedapalTechnicalSpecification.init();
});
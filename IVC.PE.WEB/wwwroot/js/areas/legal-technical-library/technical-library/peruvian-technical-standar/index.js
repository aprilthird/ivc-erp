var PeruvianTechnicalStandar = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/libreria-tecnica/normas-tecnicas-peruanas/listar"),
            dataSrc: ""
        },
        columns: [
            {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/libreria-tecnica/normas-tecnicas-peruanas/eliminar/${id}`),
                                    type: "delete",
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/libreria-tecnica/normas-tecnicas-peruanas/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/libreria-tecnica/normas-tecnicas-peruanas/crear"),
                    method: "post",
                    contentType: false,
                    processData: false,
                    data: data,
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/libreria-tecnica/normas-tecnicas-peruanas/editar/${id}`),
                    method: "put",
                    contentType: false,
                    processData: false,
                    data: data,

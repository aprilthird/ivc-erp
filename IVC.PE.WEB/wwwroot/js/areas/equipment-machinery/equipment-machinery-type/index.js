var MachineryType = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/equipos/tipo-de-equipo/listar"),
            dataSrc: ""
        },
        columns: [
            {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/equipos/tipo-de-equipo/eliminar/${id}`),
                                    type: "delete",
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/equipos/tipo-de-equipo/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/equipos/tipo-de-equipo/crear"),
                    method: "post",
                    data: data
                })
                    .always(function () {
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/equipos/tipo-de-equipo/editar/${id}`),
                    method: "put",
                    data: data
                })
                    .always(function () {

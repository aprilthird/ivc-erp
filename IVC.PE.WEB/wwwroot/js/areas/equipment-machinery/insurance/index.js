var CementType = function () {
    ...
    var options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/equipos/entidad-aseguradora/listar"),
            dataSrc: ""
        },
        columns: [
        ...
        initEvents: function () {
            ...
            mainDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "La entidad será eliminado permanentemente",
                        type: "warning",
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/equipos/entidad-aseguradora/eliminar/${id}`),
                                    type: "delete",
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/equipos/entidad-aseguradora/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/equipos/entidad-aseguradora/crear"),
                    method: "post",
                    data: data
                })
                    .always(function () {
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/equipos/entidad-aseguradora/editar/${id}`),
                    method: "put",
                    data: data
                })
                    .always(function () {

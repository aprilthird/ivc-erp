var For05 = function () {
    ...
    var selectYOption = new Option('Seleccione un Año', null, true, true);
    var selectMOption = new Option('Seleccione un Mes', null, true, true);
    ...
    var for05DtOpt = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/equipos/parte-combustible-maquinaria/listar"),
            data: function (d) {
        ...
        columns: [
            {
                title: "Año de Parte Diario Combustible",
                data: "yearPart"
            },
            {
                title: "Mes de Parte Diario Combustible",
                data: "monthPart"
            },

            {
                title: "Año de Parte Diario Maquinaria",
                data: "machPartYear"
            },
            {
                title: "Mes de Parte Diario Maquinaria",
                data: "machPartMonth"
            },
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    if (row.plate != null)
                        ...
                        tmp += row.brand + "-" + row.model + "-" + "NO TIENE PLACA";
    ...
    var foldingDtOpt = {
        responsive: true,
        ajax: {
            url: _app.parseUrl(`/equipos/parte-combustible-maquinaria-folding/listar`),
            data: function (d) {
                d.softPartId = softId;
                d.month = $("#month_filter").val();
                d.year = $("#year_filter").val();
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    var tmp = "";
                    tmp += `<button data-id="${row.id}" data-father="${row.equipmentMachPartId}" class="btn btn-info btn-sm btn-icon btn-edit">`;
                    tmp += `<i class="fa fa-edit"></i></button> `;
                    tmp += `<button data-id="${row.id}" class="btn btn-danger btn-sm btn-icon btn-delete">`;
                    tmp += `<i class="fa fa-trash"></i></button>`;
                    return tmp;
    ...
    var rateDtOpt = {
        responsive: true,
        ajax: {
            url: _app.parseUrl(`/equipos/parte-combustible-maquinaria-ratio/listar`),
            data: function (d) {
                d.fuelId = fId;
                delete d.columns;
            },
                        ...
                        Swal.fire({
                            ...
                            preConfirm: () => {
                                return new Promise((resolve) => {
                                    $.ajax({
                                        url: _app.parseUrl(`/equipos/parte-combustible-maquinaria/eliminar/${id}`),
                                        type: "delete",
                    ...
                    function () {
                        ...
                        Swal.fire({
                            ...
                            preConfirm: () => {
                                return new Promise((resolve) => {
                                    $.ajax({
                                        url: _app.parseUrl(`/equipos/parte-combustible-maquinaria-folding/eliminar/${id}`),
                                        type: "delete",
                                        success: function (result) {
                                            datatables.foldingDt.reload();
                                            datatables.for05Dt.reload();
    ...
    var forms = {
        load: {
            edit: function (id) {
                ...
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/equipos/parte-combustible-maquinaria/${id}`)
                })
            ...
            foldingFor05: function (id) {
                ...
                $.ajax({
                    ...
                    .done(function (result) {
                        ...
                        formElements.find("[name='EquipmentMachineryFuelMachPartId']").val(result.id);
                        select2.operators.reload(result.equipmentMachPartId, "")
            ...
            editfolding: function (id,fatherid,providerid) {
                ...
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/equipos/parte-combustible-maquinaria-folding/${id}`),
                    dataSrc: ""
                })
                    .done(function (result) {
                        console.log(5);
                        ...
                        formElements.find("[name='Id']").val(result.id);
                        formElements.find("[name='EquipmentMachineryFuelMachPartId']").val(result.equipmentMachineryFuelMachPartId);
                        ...
                        formElements.find("[name='Horometer']").val(result.horometer);
        ...
        submit: {
            add: function (formElement) {
                ...
                $(formElement).find("[name='EquipmentMachPartId']").val($(formElement).find("[name='select_eqtransport']").val());
                ...
                $.ajax({
                    url: _app.parseUrl("/equipos/parte-combustible-maquinaria/crear"),
                    method: "post",
                    data: data,
                    contentType: false,
                    processData: false
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/equipos/parte-combustible-maquinaria/editar/${id}`),
                    method: "put",
                    contentType: false,
                    processData: false,
                    data: data,
            ...
            import: {
                data: function (formElement) {
                    ...
                    $.ajax({
                        url: "/equipos/parte-combustible-maquinaria/importar-datos",
                        type: "POST",
                        contentType: false,
                        processData: false,
                        data: data,
            ...
            addfolding: function (formElement) {
                ...
                $btn.addLoader();
                $.ajax({
                    url: _app.parseUrl(`/equipos/parte-combustible-maquinaria-folding/crear`),
                    method: "post",
                    data: data,
                    contentType: false,
                    processData: false
            ...
            editfolding: function (formElement) {
                ...
                $btn.addLoader();
                $.ajax({
                    url: _app.parseUrl(`/equipos/parte-combustible-maquinaria-folding/editar/${id}`),
                    method: "put",
                    data: data,
                    contentType: false,
                    processData: false
    ...
    var select2 = {
        ...
        parts: {
            init: function () {
                $.ajax({
                    url: _app.parseUrl("/select/parte-maquinaria-filtro")
                }).done(function (result) {
        ...
        eqtransports: {
            ...
            reload: function (id) {
                let sg = id;
                $.ajax({
                    url: _app.parseUrl(`/select/parte-maquinaria-seleccionado?equipmentProviderId=${sg}`)
                }).done(function (result) {
        ...
        operators: {
            ...
            reload: function (id, actId) {
                $.ajax({
                    url: _app.parseUrl(`/select/operador-maquinaria-parte-seleccionado?opId=${id}`)
                }).done(function (result) {

var Formula = function () {
    ...
    var options = {
        ...
        scrollX: true,
        ajax: {
            url: _app.parseUrl("/equipos/valorizacion-combustible-maquinaria/listar"),
            dataSrc: "",
            data: function (d) {
        ...
        buttons: [
            {
                ...
                action: function (e, dt, node, config) {
                    ...
                    window.location = `/equipos/valorizacion-combustible-maquinaria/detalle-folding-excel?week=${param1}&year=${param2}`;
                }
            }
        ],
        columns: [
            ...
            {
                title: "Total Horometro",
                data: "dif"
            },
            {
                title: "Ratio de Consumo (hm/gln)",
                data: "kGallon",
                render: function (data, type, row) {
                    if (data > 0) {
                        return `
    ...
    var detail_options = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/equipos/valorizacion-combustible-maquinaria/detalles-listar"),
            dataSrc: "",
            data: function (d) {
    ...
    var events = {
        init: function () {
            ...
            $("#week_param,#provider_param,#mach_param").on("change", function () {
                mainDatatable.ajax.reload();
                foldingDataTable.ajax.reload();
            });

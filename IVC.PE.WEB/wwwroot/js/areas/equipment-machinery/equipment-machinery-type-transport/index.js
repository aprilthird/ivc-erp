        ...
        initEvents: function () {
            ...
            mainDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "El tipo de equipo transporte será eliminada permanentemente",
                        type: "warning",
                                ...
                                $.ajax({
                                    ...
                                    success: function (result) {
                                        ...
                                        swal.fire({
                                            type: "success",
                                            title: "Completado",
                                            text: "El tipo de equipo transporte ha sido eliminado con éxito",
                                    ...
                                    error: function (errormessage) {
                                        swal.fire({
                                            ...
                                            text: "Ocurrió un error al intentar eliminar el tipo de equipo transporte"
                                        });
                                    }
                                });
                            });
        ...
        submit: {
            ...
            import: {
                data: function (formElement) {
                    ...
                    $.ajax({
                        url: "/equipos/tipo-de-equipo-transporte/importar-datos",
                        type: "POST",
                        contentType: false,
                        processData: false,
                        data: data,

var For05 = function () {
    ...
    var for05DtOpt = {
        responsive: true,
        ajax: {
            url: _app.parseUrl("/equipos/fase-maquinaria/listar"),
            data: function (d) {
                        ...
                        Swal.fire({
                            ...
                            preConfirm: () => {
                                return new Promise((resolve) => {
                                    $.ajax({
                                        url: _app.parseUrl(`/equipos/fase-maquinaria/eliminar/${id}`),
                                        type: "delete",
    ...
    var forms = {
        load: {
            edit: function (id) {
                ...
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/equipos/fase-maquinaria/${id}`)
                })
        ...
        submit: {
            import: {
                data: function (formElement) {
                    ...
                    $.ajax({
                        url: "/equipos/fase-maquinaria/importar-datos",
                        type: "POST",
                        contentType: false,
                        processData: false,
                        data: data,
            ...
            add: function (formElement) {
                ...
                $(formElement).find("input").prop("disabled", true);
                $.ajax({
                    url: _app.parseUrl("/equipos/fase-maquinaria/crear"),
                    method: "post",
                    data: data,
                    contentType: false,
                    processData: false
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/equipos/fase-maquinaria/editar/${id}`),
                    method: "put",
                    contentType: false,
                    processData: false,
                    data: data,
    ...
    var select2 = {
        ...
        equipproviders2: {
            init: function () {
                $.ajax({
                    url: _app.parseUrl("/select/fase-maquinaria")
                }).done(function (result) {
    ...
    var events = {
        ...
        excel: function () {
            $("#btn-massive-load").on("click", function () {
                window.location = `/equipos/fase-maquinaria/excel-carga-masiva`;
            });
        },

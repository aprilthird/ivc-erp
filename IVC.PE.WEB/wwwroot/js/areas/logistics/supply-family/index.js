var SupplyFamily = function () {
    ...
    var datatable = {
        ...
        initEvents: function () {
            supplyFamilyDatatable.on("click",
                ".btn-edit",
                function () {
                    let $btn = $(this);
                    let id = $btn.data("id");
            ...
            supplyFamilyDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "La familia será eliminada permanentemente",
                        type: "warning",
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/logistica/familias/eliminar/${id}`),
                                    type: "delete",
                                    success: function (result) {
                                        ...
                                        swal.fire({
                                            type: "success",
                                            title: "Completado",
                                            text: "La familia ha sido eliminada con éxito",
                                    ...
                                    error: function (errormessage) {
                                        swal.fire({
                                            ...
                                            text: "Ocurrió un error al intentar eliminar la familia"
                                        });
                                    }
                                });
                            });
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/logistica/familias/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/logistica/familias/crear"),
                    method: "post",
                    data: data
                })
                    .always(function () {
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/logistica/familias/editar/${id}`),
                    method: "put",
                    data: data
                })
                    .always(function () {
            ...
            import: function (formElement) {
                ...
                $.ajax({
                    url: "/logistica/familias/importar",
                    type: "POST",
                    contentType: false,
                    processData: false,
                    data: data,
    ...
    var events = {
        init: function () {
            $("#genEsxelSample").on("click", function () {
                window.location = _app.parseUrl(`/logistica/familias/excel-modelo`);
            });
        }
    };

var Request = function () {
    ...
    var options = {
        ...
        ajax: {
            url: _app.parseUrl("/logistica/requerimientos/atencion/listar"),
            dataSrc: ""
        },
        columns: [
            {
    ...
    var datatable = {
        ...
        initEvents: function () {
            mainDatatable.on("change", ".select2-attention-status", function () {
                ...
                let value = $(this).val();
                $.ajax({
                    url: _app.parseUrl(`/logistica/requerimientos/${id}/actualizar-atencion`),
                    method: "post",
                    data: {
                        status: value
                    }
    ...
    var select2 = {
        ...
        supplyFamilies: {
            init: function () {
                $.ajax({
                    url: _app.parseUrl("/select/s - de - insumos")
                }).done(function (result) {

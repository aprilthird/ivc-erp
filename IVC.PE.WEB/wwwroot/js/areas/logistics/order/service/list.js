var Order = function () {
    ...
    var options = {
        ...
        processing: true,
        ajax: {
            url: _app.parseUrl("/logistica/ordenes/servicio/listado/listar"),
            data: function (d) {
    ...
    var datatable = {
        ...
        initEvents: function () {
            ...
            mainDatatable.on("change", ".select2-status", function () {
                ...
                let value = $(this).val();
                $.ajax({
                    url: _app.parseUrl(`/logistica/ordenes/servicio/${id}/actualizar-estado`),
                    method: "post",
                    data: {
                        status: value
                    }
            ...
            */
            mainDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "La Orden de servicio será aprobado",
                        type: "warning",
                                ...
                                $.ajax({
                                    ...
                                    success: function (result) {
                                        swal.fire({
                                            type: "success",
                                            title: "Completado",
                                            text: "La Orden de servicio ha sido aprobado con éxito",
                                    ...
                                    error: function (errormessage) {
                                        swal.fire({
                                            ...
                                            text: "Ocurrió un error al intentar aprobar la Orden de servicio"
                                        });
                                    }
                                });
                            });
            ...
            mainDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "La Orden de servicio será anulado",
                        type: "warning",
                        showCancelButton: true,
                                ...
                                $.ajax({
                                    ...
                                    success: function (result) {
                                        swal.fire({
                                            type: "success",
                                            title: "Completado",
                                            text: "La Orden de servicio ha sido anulado con éxito",
                                            confirmButtonText: "Excelente"
                                        });
                                        datatable.reload();
                                    },
                                    error: function (errormessage) {
                                        swal.fire({
                                            ...
                                            customClass: 'animated tada',
                                            confirmButtonText: "Entendido",
                                            text: "Ocurrió un error al intentar anular la Orden de servicio"
                                        });
                                    }
                                });
                            });

var MeasurementUnit = function () {
    ...
    var datatable = {
        ...
        initEvents: function () {
            measurementUnitDatatable.on("click",
                ".btn-edit",
                function () {
                    let $btn = $(this);
                    let id = $btn.data("id");
            ...
            measurementUnitDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "La unidad de medida será eliminada permanentemente",
                        type: "warning",
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/logistica/unidades/eliminar/${id}`),
                                    type: "delete",
                                    ...
                                    error: function (errormessage) {
                                        swal.fire({
                                            ...
                                            text: "Ocurrió un error al intentar eliminar la unidad de medida"
                                        });
                                    }
                                });
                            });
    ...
    var form = {
        load: {
            edit: function (id) {
                _app.loader.show();
                $.ajax({
                    url: _app.parseUrl(`/logistica/unidades/${id}`)
                })
        ...
        submit: {
            add: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl("/logistica/unidades/crear"),
                    method: "post",
                    data: data
                })
                    .always(function () {
            ...
            edit: function (formElement) {
                ...
                $.ajax({
                    url: _app.parseUrl(`/logistica/unidades/editar/${id}`),
                    method: "put",
                    data: data
                })
                    .always(function () {
            ...
            import: function (formElement) {
                ...
                $.ajax({
                    url: "/logistica/unidades/importar",
                    type: "POST",
                    contentType: false,
                    processData: false,
                    data: data,
